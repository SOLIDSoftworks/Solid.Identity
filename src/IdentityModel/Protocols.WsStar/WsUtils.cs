...
namespace Solid.IdentityModel.Protocols
{
    ...
    public static class WsUtils
    {
        ...
        /// <returns></returns>
        public static XmlElement ReadAsXmlElement(XmlDictionaryReader reader)
        {
        ...
        /// </summary>
        public static void ValidateParamsForWriting(XmlWriter writer, WsSerializationContext serializationContext, object obj, string objName)
        {
            if (writer == null)
        ...
        public static void CheckReaderOnEntry(XmlReader reader, string element, WsSerializationContext serializationContext)
        {
            ...
            if (!reader.IsStartElement(element, serializationContext.Trust.Namespace))
                throw XmlUtil.LogReadException(LogMessages.IDX15011, serializationContext.Trust.Namespace, element, reader.NamespaceURI, reader.LocalName);
        }
    }
}
