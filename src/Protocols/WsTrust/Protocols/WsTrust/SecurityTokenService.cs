...
using Solid.IdentityModel.Protocols.XmlEnc;
...
namespace Solid.Identity.Protocols.WsTrust
{
    public class SecurityTokenService : ISecurityTokenService
    {
        ...
        protected virtual ValueTask<RandomNumberGenerator> CreateRandomNumberGeneratorAsync() => new (RandomNumberGenerator.Create());
