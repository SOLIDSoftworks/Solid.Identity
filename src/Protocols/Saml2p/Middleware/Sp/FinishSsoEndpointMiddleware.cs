...
namespace Solid.Identity.Protocols.Saml2p.Middleware.Sp
{
    internal class FinishSsoEndpointMiddleware : Saml2pEndpointMiddleware
    {
        ...
        public async Task<FinishSsoResult> FinishSsoAsync(HttpContext context)
        {
            ...
            using (Tracing.Saml2p.StartActivity($"{nameof(Saml2pServiceProviderEvents)}.{nameof(Saml2pServiceProviderEvents.OnFinishSso)}"))
            ...
            using (Tracing.Saml2p.StartActivity($"{nameof(Saml2pServiceProviderEvents)}.{nameof(Saml2pServiceProviderEvents.OnValidatingToken)}"))
            ...
            {
                using (Tracing.Saml2p.StartActivity($"{nameof(Saml2SecurityTokenHandler)}.{nameof(Saml2SecurityTokenHandler.ValidateToken)}"))
                {
            ...
            using (Tracing.Saml2p.StartActivity($"{nameof(Saml2pServiceProviderEvents)}.{nameof(Saml2pServiceProviderEvents.OnValidatedToken)}"))
