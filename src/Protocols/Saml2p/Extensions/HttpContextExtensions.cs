...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    {
        ...
        {
            using var activity = Tracing.Saml2p.StartActivity($"{nameof(HttpContext)}.{nameof(StartSsoAsync)}");
        ...
        {
            using var activity = Tracing.Saml2p.StartActivity($"{nameof(HttpContext)}.{nameof(FinishSsoAsync)}");
